      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row py-0">
            ...
            <div class="col-lg-4 col-sm-4 col-6 grid-margin mb-0 text-end">
              <a href="<?= _DIRECTORY_ ?>reporteDeudas" type="button" class="text-white btn btn-warning btn-icon-text ">
