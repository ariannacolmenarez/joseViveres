              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content modal-fullscreen w-100">
                  ...
                  <div class="mt-3 form-group ">
                      ...
                      <div>
                        <select class="form-select  mb-3 shadow-none" id="cat" aria-label=".form-select example">
                  ...
                  <div class="form-group mt-3">
                      ...
                      <input type="date" class="form-control" id="fechav" placeholder="Fecha de la Venta"  value="<?php echo date("Y-m-d");?>">
                  </div>
                  <div class="form-group mt-3">
                      <h5>Hora del gasto *</h5>
                      <input type="time" class="form-control" id="horav" placeholder="Hora de la Venta"  value="<?php ini_set('date.timezone','America/Caracas'); echo date("H:i");?>">
                  </div>
                  <h5 class="mt-3">Valor del gasto *</h5>
                  <div class="input-group ">
                    <input type="text" class="form-control" id="montov" aria-label="Dollar amount (with dot and two decimal places)">
                  ...
                  <div class="btn-group-md text-center" role="group" id="metodov">
                      ...
                      <input type="radio" class="btn-check" name="metodo" id="option1" autocomplete="off" checked value="1">
                  ...
                  <div class="mt-3 form-group ">
                      ...
                      <select class="form-select  mb-3 shadow-none" id="proveedorv"  aria-label=".form-select example">
