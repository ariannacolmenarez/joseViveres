...
<div class="modal fade" id="exampleModalToggle7" aria-hidden="true" aria-labelledby="exampleModalToggleLabel7" tabindex="-1">
            ...
            <div class="modal-content modal-fullscreen w-100">
              ...
              <div class="modal-body">
                ...
                <div class="list-group list-group-flush mt-2">
                    <a type="button" data-bs-target="#exampleModalToggle8" data-bs-toggle="modal" class="list-group-item text-dark list-group-item-action py-3">
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-fullscreen w-100">
              <div class="modal-header text-center">
                <h5 class="modal-title fs-5 display-6 fw-bold" id="exampleModalToggleLabel8"><a type="button" data-bs-target="#exampleModalToggle7" data-bs-toggle="modal"><i class="ti-arrow-left"></i> </a>  Editar Cliente</i></h5>
              </div>
              <div class="modal-body">
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-fullscreen w-100">
              <div class="modal-header text-center">
                <h5 class="modal-title fs-5 display-6 fw-bold" id="exampleModalToggleLabel9"><a type="button" data-bs-target="#exampleModalToggle7" data-bs-toggle="modal"><i class="ti-arrow-left"></i> </a> Nuevo Cliente</i></h5>
              </div>
              <div class="modal-body">
                <h5 class="mt-3">Nombre *</h5>
                <div class="input-group mt-1">
