...
<div class="modal fade" id="exampleModalToggle7" aria-hidden="true" aria-labelledby="exampleModalToggleLabel7" tabindex="-1">
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-fullscreen w-100">
              <div class="modal-header text-center">
                <h5 class="modal-title fs-5 display-6 fw-bold" id="exampleModalToggleLabel8"><a type="button" id="volver8" data-bs-target="#exampleModalToggle7" data-bs-toggle="modal"><i class="ti-arrow-left"></i> </a>  Editar Cliente</i></h5>
              </div>
              ...
              <div class="modal-body">
                ...
                <div class="input-group ">
                    <select class="input-group-text" aria-label="Default select example" id="tipo_doccliente">
