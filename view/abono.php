            ...
            <div class="modal-content modal-fullscreen w-100">
              ...
              <div class="modal-body">
                <div class="form-group mt-1">
                  ...
                  <input type="date" class="form-control form-control-lg" placeholder="Fecha de la Venta" id="fechaA" value="<?php echo date("Y-m-d");?>">
                </div>
                ...
                <div class="btn-group-md text-center" role="group"> 
                    <input type="radio" class="btn-check" name="opciones" id="opciones1" value="1">
